...
from dataloader.fair_dataset import TrainDataset, TestDataset
...
class TrainDataSetWrapper(object):
    def __init__(self, batch_size, num_workers, s, csv_file, img_root_dir, input_shape, img_path_col, text_root_dir, text_col1, text_col2, label_col, fitz_scale_col):
