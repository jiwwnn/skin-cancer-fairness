...
from dataloader.cls_dataset import TrainImageDataset, TestImageDataset
# from cls_dataset import TrainImageDataset, TestImageDataset
...
class TrainClsDataSetWrapper(object):
    def __init__(self, batch_size, num_workers, input_shape, s, csv_file, img_root_dir, text_root_dir, img_path_col, label_col):
...
if __name__ == '__main__':    
    ...
    test_dataset = TestClsDataSetWrapper(batch_size=config['batch_size'], **config['test_cls_dataset'])
