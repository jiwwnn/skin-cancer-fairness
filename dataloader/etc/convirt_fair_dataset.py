...
class TrainDataset(Dataset):
    ...
    def __init__(self, csv_file, img_root_dir, input_shape, img_path_col, text_root_dir, text_col1, label_col, fitz_scale_col, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'image': image, 'phrase1': phrase1, 'label':label, 'fitz_scale':fitz_scale}
