...
df.loc[:, 'fitzpatrick_description'] = df.apply(lambda x: fitzpatrick_cls(x['generated_sentence']), axis=1)
df.loc[:, 'lesion_description'] = df.apply(lambda x: lesion_cls(x['generated_sentence']), axis=1)
