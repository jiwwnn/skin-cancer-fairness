...
def _save_config_file(model_checkpoints_folder):
    if not os.path.exists(model_checkpoints_folder):
        ...
        shutil.copy('./rewt_config.yaml', os.path.join(model_checkpoints_folder, 'rewt_config.yaml'))  
...
class REWT: 
    def __init__(self, config):
        ...
        self.model = nn.DataParallel(ModelREWT().to(self.device))
