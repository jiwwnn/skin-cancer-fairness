...
class ModelCLCLS(nn.Module):
    def __init__(self, res_base_model, bert_base_model, out_dim, freeze_layers, do_lower_case):
        ...
        # resnet.load_state_dict(torch.load('/dshome/ddualab/jiwon/ConVIRT-pytorch/data/skin_cancer_classifier_resnet_18_final.pth'), strict=False)
