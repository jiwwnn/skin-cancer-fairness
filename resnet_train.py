...
def _save_config_file(model_checkpoints_folder):
    if not os.path.exists(model_checkpoints_folder):
        ...
        shutil.copy('./resnet_config.yaml', os.path.join(model_checkpoints_folder, 'resnet_config.yaml'))
...
class ResNet50:
    def __init__(self, config):
        ...
        self.model = nn.DataParallel(ModelResNet().to(self.device))                                                    
    ...
    # def valid(self, valid_cls_loader):
    #     self.model.eval()
    #     total_loss = 0
    #     correct = 0
    #     lighter_correct = 0
