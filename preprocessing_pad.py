...
# df = df[(df['fitzpatrick_scale']== 1.0) | (df['fitzpatrick_scale']== 2.0)]
df = df[(df['fitzpatrick_scale']== 3.0) | (df['fitzpatrick_scale']== 4.0)]
...
# train_df.to_csv('data/in_m_train_df.csv', index=False)
# test_df.to_csv('data/in_m_test_df.csv', index=False)
df.to_csv('data/out_fitz34_b_df.csv', index=False)