...
from dataloader.patchalign_dataset import TrainDataset, TestDataset
...
class TrainDataSetWrapper(object):
    def __init__(self, batch_size, num_workers, s, csv_file, img_root_dir, input_shape, img_path_col, text_root_dir, label_col, fitz_scale_col, label_text_col):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = TrainDataset(
            ...
            label_text_col = self.label_text_col,
...
class SimCLRDataTransform(object):
    ...
    def __call__(self, sample):
        ...
        return image, label, fitz_scale, label_text
